...
test(`Проверка стилей co светлой темой `, async () => {
  ...
  await test.step ('Скриншотная проверка c активной светлой темой', async() =>{
...
test(`Проверка стилей co темной темой `, async () => {
  ...
  await test.step ('Скриншотная проверка c активной темной темой', async() =>{
...
test(`Проверка стилей co системной темой `, async () => {
  ...
  await test.step ('Скриншотная проверка c активной системной темой', async() =>{
